        ...
        <footer className="bg-black text-white py-20">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-20">
                ...
                <div className='lg:px-4 md:px-2 px-20'>
                    ...
                    <p className='text-xs'>Se hai voglia di fare i primi passi assieme a me nel mondo dell'informazione.</p>
                ...
                <div className='lg:px-4 md:px-2 px-20'>
                    ...
                    <p className='text-xs'>Stay updated on the best practices and principles of UI design.</p>
